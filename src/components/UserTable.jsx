...
function createData(id, profile, phone, gender, dob, personalDetails, edu) {
  return { id, profile, phone, gender, dob, personalDetails, edu };
}
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">{row.personalDetails}</TableCell>
